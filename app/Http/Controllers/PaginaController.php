...
class PaginaController extends Controller
{
    ...
    {
        // Obtener productos destacados (ej: los primeros 3)
        $destacados = Producto::whereIn('producto_id', [1, 7, 11])->get();

        // Obtener combos (ej: todos menos los destacados)
        $combos = Producto::whereNotIn('producto_id', [1, 7, 11])->limit(9)->get();
