...
@section('titulo', 'Crear Producto - Admin UMAMI')
@section('titulo-seccion', 'Crear Nuevo Producto')
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('admin.productos.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="descripcion_corta" name="descripcion_corta" class="form-control @error('descripcion_corta') is-invalid @enderror" placeholder="Ej: Medallón de gírgolas, cheddar vegano..." value="{{ old('descripcion_corta') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="precio" name="precio" class="form-control @error('precio') is-invalid @enderror" step="1" value="{{ old('precio') }}">
                                </div>
                                @error('precio') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="stock" class="form-label">Stock</label>
                                <input type="number" id="stock" name="stock" class="form-control @error('stock') is-invalid @enderror" value="{{ old('stock', 0) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="etiqueta" name="etiqueta" class="form-control @error('etiqueta') is-invalid @enderror" placeholder="Ej: Clásico, Picante, Gourmet" value="{{ old('etiqueta') }}">
