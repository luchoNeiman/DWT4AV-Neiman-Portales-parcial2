            ...
            <div class="card shadow-sm">
                <div class="card-body p-4 p-md-5">
                    ...
                    <form action="{{ route('admin.productos.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="descripcion_corta" class="form-label">Descripción Corta (Tarjetas)</label>
                            <input type="text" id="descripcion_corta" name="descripcion_corta"
                                ...
                                placeholder="Ej: Medallón de gírgolas, cheddar vegano..."
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="etiqueta" name="etiqueta"
                                ...
                                placeholder="Ej: Clásico, Picante, Gourmet"
                                value="{{ old('etiqueta') }}">
                            @error('etiqueta')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
